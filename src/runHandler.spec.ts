...
describe('runHandler()', () => {
  ...
  describe('handles valid responses', () => {
    it('should handle context.done() finalized handlers', done => {
      const handler: APIGatewayProxyWithCognitoAuthorizerHandler = (_, context) => {
    ...
    it('should handle callback finalized handlers', done => {
      const handler: APIGatewayProxyWithCognitoAuthorizerHandler = (_, __, callback) => {
  ...
  describe('only allows one resolution', () => {
    describe('multiple resolves', () => {
      it('context and callback', done => {
        ...
        const handler: APIGatewayProxyWithCognitoAuthorizerHandler = (_, context, callback) => {
      ...
      it('context and async', done => {
        ...
        const handler: APIGatewayProxyWithCognitoAuthorizerHandler = async (_, context) => {
          context.done(undefined, validResponse);
      ...
      it('callback and async', done => {
        ...
        const handler: APIGatewayProxyWithCognitoAuthorizerHandler = async (_, __, callback) => {
